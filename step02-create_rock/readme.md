...
***Note: the code below will be placed in the***
...
***Note: the next two lines of code go in the***
...
***Note: we will put the ```move_rock()``` function in the***
...
If you have followed all the instructions in step 2 your code should look something like [this](ex_step02.md).
