...
Can you write a function with the name `create_rock` which creates a Turtle object called ```rock```, tells it to use the `asteroid.png` image and to take the pen up. (The solution is below.)
